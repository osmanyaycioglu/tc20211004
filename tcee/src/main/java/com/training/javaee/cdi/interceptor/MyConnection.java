...
public class MyConnection implements Connection {
    ...
    @Override
    public boolean setShardingKeyIfValid(final ShardingKey shardingKeyParam,
                                         final ShardingKey superShardingKeyParam,
                                         final int timeoutParam) throws SQLException {
        return this.connection.setShardingKeyIfValid(shardingKeyParam,
                                                     superShardingKeyParam,
                                                     timeoutParam);
    }
    ...
    @Override
    public void setShardingKey(final ShardingKey shardingKeyParam,
                               final ShardingKey superShardingKeyParam) throws SQLException {
        this.connection.setShardingKey(shardingKeyParam,
                                       superShardingKeyParam);
    }

    @Override
    public void setShardingKey(final ShardingKey shardingKeyParam) throws SQLException {
        this.connection.setShardingKey(shardingKeyParam);
    }
